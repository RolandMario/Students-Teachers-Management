        ...
        {step === 1 && (
          <form onSubmit={handleSubmit(handleEmailSubmit)} className="space-y-5">
            ...
            <button
              ...
              className={`w-full bg-indigo-500 text-white py-2 rounded-lg font-semibold hover:bg-orange-600 transition ${!canResend ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
        ...
        {step === 2 && otpSent && (
          <form onSubmit={handleSubmit(handleOtpSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-500 text-white py-2 rounded-lg font-semibold hover:bg-orange-600 transition"
            >
